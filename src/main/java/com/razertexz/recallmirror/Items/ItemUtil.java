...
public final class ItemUtil {
	...
	public static final BlockPos getSpawnLocation(final World world, final EntityPlayer player) {
		final BlockPos bedLocation = player.getBedLocation(0);
		if (world.getBlockState(bedLocation).getBlock() != Blocks.BED) {
        	return world.getSpawnPoint();
        }

        return bedLocation.add(0.5, 1, 0.5);
	}
}
